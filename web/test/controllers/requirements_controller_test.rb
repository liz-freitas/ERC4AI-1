...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference("Requirement.count") do
      post requirements_url, params: { requirement: { content: @requirement.content, ethic: @requirement.ethic } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { content: @requirement.content, ethic: @requirement.ethic } }
